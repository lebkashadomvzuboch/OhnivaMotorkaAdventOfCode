...
for index_znaku in range(len(riadok)):
    if riadok[index_znaku:index_znaku+4] == "do()":
        mozes = True
    elif riadok[index_znaku:index_znaku+7] == "don't()":
        mozes = False
    ...
    if riadok[index_znaku:index_znaku+4] == "mul(":
        ...
        if koniec:
            ...
            if cislo1 and cislo2 and 0 < len(str(cislo1)) < 4 and 0 < len(str(cislo2)) < 4 and mozes:
                vysledok += cislo1*cislo2

print(vysledok)
# vysledok je 92626942
