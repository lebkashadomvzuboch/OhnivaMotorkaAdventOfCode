...
for priecinok in priecinky:
    ...
    velkosti_priecinkov[priecinok] = v

treba = 30000000 - (70000000 - velkosti_priecinkov["/"])
print(min([v for v in velkosti_priecinkov.values() if v >= treba]))
